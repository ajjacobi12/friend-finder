                ...
                <View style={{ width: 100, justifyContent: 'center' }}>
                    <Pressable 
                        ...
                        style={({ pressed }) => [
                            ...
                            { width: 62, minWidth: 50, borderWidth: 3, paddingLeft: 10, paddingRight: 8 },
                ...
                <View style={{ flex: 1, alignItems: 'flex-end', justifyContent: 'center'}}>
                    ...
                    <Pressable 
                        ...
                        style={({ pressed }) => [
                            styles.headerButton, 
                            styles.headerButtonDanger,
                            { borderWidth: 3, width: 62, minWidth: 50 },
                            pressed && styles.headerButtonDangerPressed,
                        ]}>
                            <Ionicons 
                                name="power-outline"
                    ...
                    <View style={[styles.friendBadge, 
                        ...
                        <TextTicker 
                            ...
                            style={[ styles.friendIdText, 
                                { fontSize: 28, fontWeight: 'bold', textAlignVertical: 'center', height: 50, lineHeight: 50, marginLeft: 15, lineHeight: 55  }
                                ]}
                        >
                            { name || "Loading..."}
                        </TextTicker>
