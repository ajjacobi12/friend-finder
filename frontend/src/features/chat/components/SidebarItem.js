// frontend/src/features/chat/components/SidebarItem.js
...
export default function Sidebar({ isVisible, setIsSidebarVisible, navigation, isDM, currentChatRoomID }) {
    ...
    const startPrivateChat = useCallback((targetUser) => {
        ...
        if (isDM && currentChatRoomID == DMroomID) {
    ...
    }, [userUUID, navigation, setIsSidebarVisible, isDM, currentChatRoomID]);
