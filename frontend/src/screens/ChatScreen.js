// frontend/src/screens/ChatScreens.js
...
export default function ChatScreen({ navigation, route }) {
    ...
    const {
        ...
        sessionID, userUUID,
        unreadRooms, currentChatRoomID,
        hasUnreadDMs, hasUnreadGroup, pulseAnim
    } = useChatLogic({ isDirectMessage, DMroomID, navigation, isFocused, isSidebarVisible, newMsgBelow });
    ...
    useEffect(() => {
        ...
        const isMyMessage = messages[0].senderUUID === userUUID;
                        ...
                        <Pressable
                            ...
                            style={({ pressed }) => [
                                ...
                                styles.headerButtonStandard,
                                {
                                    ...
                                    borderColor: hasUnreadGroup ? 'rgba(135, 206, 250, 0.8)' : 'rgba(0, 0, 0, 0.1)', 
                                }
                            ]}
                        >
                            {({ pressed }) => (
                    ...
                    <Pressable
                        ...
                        style={({ pressed }) => [
                            ...
                            styles.headerButtonStandard,
                            {
                                ...
                                paddingRight: 0,
                                paddingLeft: 8,
                                borderColor: hasUnreadDMs ? 'rgba(135, 206, 250, 0.8)' : 'rgba(0, 0, 0, 0.1)', 
                            }
                        ]}
                    >
                        {({ pressed }) => (
                ...
                >
                    ...
                    {message.length > 400 && (
                        <Text style={{
                            ...
                            marginTop: 4,
                            fontSize: 10,
                            color: message.length >= maxMsgLength ? '#ff3b30' : '#888'
                        }}>
                            {maxMsgLength - message.length} characters remaining
                        </Text>
                    )}
