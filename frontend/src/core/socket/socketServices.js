// frontend/src/core/socket/socketServices.js
...
// ------  CHAT FUNCTIONS --------
export const sendMsgAction = (outboundData) => {
    return secureEmit('send-message', outboundData );
};

export const editMsgAction = (msgID, chatRoomID, newText) => {
    return secureEmit('edit-message', { msgID, chatRoomID, newText});
};

export const deleteMsgAction = (msgID, chatRoomID) => {
